...
Component: j-ClipboardImage
Version: 1
Updated: 2023-05-26T22:44:05.000Z
Author: Peter Širka
...
Component: j-FaviconUnread
Version: 1
Updated: 2024-08-19T08:57:00.000Z
Author: Peter Širka
...
Component: j-IdleTime
Version: 1
Updated: 2024-06-18T15:32:00.000Z
Author: Peter Širka


Component: j-iFramePreview
Version: 1
Updated: 2023-05-24T08:08:02.000Z
Author: Peter Širka
...
Component: j-Input
Version: 1
Updated: 2025-02-26T16:18:00.000Z
Author: Peter Širka
...
Component: j-NativeNotifications
Version: 1
Updated: 2023-05-25T11:43:01.000Z
Author: Peter Širka
...
Component: j-ObjectEditor
Version: 1
Updated: 2025-03-10T10:04:00.000Z
Author: Peter Širka
...
Component: j-Paper
Version: 1
Updated: 2024-06-12T10:46:00.000Z
Author: Peter Širka
...
Component: j-RawInput
Version: 1
Updated: 2024-06-19T14:30:00.000Z
Author: Peter Širka
...
Version: 1
Updated: 2025-02-20T09:49:00.000Z
Author: Peter Širka
...
Version: 1
Updated: 2025-01-21T16:11:00.000Z
Author: Peter Širka
...
.ui-oe{font-size:12px;border:1px solid #E0E0E0;padding:10px;border-radius:var(--radius);box-sizing:border-box;background-color:#FFF}.ui-oe input,.ui-oe textarea{font-family:Arial;font-size:12px !important}.ui-oe-group{margin:15px 0}.ui-oe-group > .ui-oe-label{font-size:11px;color:#A0A0A0;border-bottom:1px solid #E0E0E0;margin-bottom:5px;padding:3px 10px;float:none !important;width:auto !important}.ui-oe-group > .ui-oe-items > .ui-oe-item span{margin-left:10px}.ui-oe-array{margin:15px 0;border:1px solid #E0E0E0;border-radius:var(--radius)}.ui-oe-array > .ui-oe-label{font-size:11px;color:#A0A0A0;padding:3px 10px;border-bottom:1px solid #E0E0E0;float:none !important;width:auto !important}.ui-oe-array > .ui-oe-items > .ui-oe-item span{margin-left:10px}.ui-oe-item:last-child span{border-bottom:0}.ui-oe-item:last-child .ui-oe-control{border-bottom:0}.ui-oe-label{width:30%;float:left;font-weight:bold}.ui-oe-label span{display:block;border-bottom:1px solid #E0E0E0;line-height:23px}.ui-oe-label .ti{margin-right:5px}.ui-oe-control{border-bottom:1px solid #E0E0E0;line-height:0}.ui-oe-null{height:24px}.ui-oe-null .ui-oe-label{width:30%;float:left;font-weight:bold}.ui-oe-null .ui-oe-control{margin-left:30%;height:24px;padding:10px 0 0 5px;color:#A0A0A0}.ui-oe-date{height:24px}.ui-oe-date .ui-oe-control{margin-left:30%}.ui-oe-date input{background-color:transparent;border:0;width:100%;outline:0;padding:3px 5px 0;margin:0;background-color:#F8F8F8;height:23px}.ui-oe-string{height:24px}.ui-oe-string .ui-oe-control{margin-left:30%}.ui-oe-string input{background-color:transparent;border:0;width:100%;outline:0;padding:3px 5px 0;margin:0;background-color:#F8F8F8;height:23px;resize:none;line-height:14px}.ui-oe-string-multiline{height:60px}.ui-oe-string-multiline .ui-oe-control{margin-left:30%}.ui-oe-string-multiline textarea{background-color:transparent;border:0;width:100%;outline:0;padding:3px 5px 0;margin:0;background-color:#F8F8F8;height:59px;resize:none;line-height:14px}.ui-oe-string-multiline .ui-oe-label span{height:60px}.ui-oe-number{height:24px}.ui-oe-number .ui-oe-control{margin-left:30%}.ui-oe-number input{background-color:transparent;border:0;width:100%;outline:0;padding:3px 5px 0;margin:0;background-color:#F8F8F8;height:23px}.ui-oe-boolean{height:24px}.ui-oe-boolean .ui-oe-control{margin-left:30%;height:24px;padding:4px 0 0 3px}.ui-oe-boolean .ui-eo-checkbox{width:15px;height:15px;background-color:#E0E0E0;margin:0;border-radius:var(--radius);text-align:center;padding:2px 0 0;cursor:pointer;color:#FFF;font-size:10px}.ui-oe-boolean .ui-eo-checkbox .ti{display:none}.ui-oe-boolean .ui-eo-checkbox.checked .ti{display:block}.ui-oe-boolean .ui-eo-checkbox.checked{background-color:#4584F1}.ui-dark .ui-oe{border-color:#404040;background-color:#252525}.ui-dark .ui-oe-number input{background-color:#303030}.ui-dark .ui-oe-string input{background-color:#303030}.ui-dark .ui-oe-date input{background-color:#303030}.ui-dark .ui-oe-control{border-bottom-color:#404040}.ui-dark .ui-oe-group > .ui-oe-label{border-bottom-color:#404040}.ui-dark .ui-oe-control{border-bottom-color:#404040}.ui-dark .ui-oe-label span{border-bottom-color:#404040}.ui-dark .ui-oe-array > .ui-oe-label{border-bottom-color:#404040}.ui-dark .ui-oe-array{border-color:#404040}

.page{position:absolute;z-index:10;background-color:#FFF}

.ui-paper{font-size:15px;font-family:Arial;padding:15px 0}.ui-paper [contenteditable]{outline:0}.ui-paper section{padding-bottom:10px;position:relative}.ui-paper .paper-html{min-height:16px;display:inline-block;width:100%}.ui-paper-placeholder{position:absolute;opacity:0.4;pointer-events:none;margin-left:3px}.ui-paper-first{height:10px}
...
.ui-rawinput-monospace input{font-family:Menlo,Consolas,monospace}
...
COMPONENT('clipboardimage','quality:90;maxwidth:1024;maxheight:768;type:jpg;output:base64',function(self,config){var ctx,img,canvas=null;self.singleton();self.readonly();self.blind();self.nocompile();function dataURLtoFile(dataurl,filename){var arr=dataurl.split(',');var mime=arr[0].match(/:(.*?);/)[1];var bstr=atob(arr[arr.length-1]);var n=bstr.length,u8arr=new Uint8Array(n);while(n--)u8arr[n]=bstr.charCodeAt(n);return new File([u8arr],filename,{type:mime})}self.make=function(){self.aclass('hidden');self.append('<canvas></canvas><img src="data:image/png;base64,R0lGODdhAQABAIAAAHnrWAAAACH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==" />');canvas=self.find('canvas')[0];ctx=canvas.getContext('2d');img=self.find('img')[0];$(W).on('paste',function(e){if(config.disabled)return;var item=e.originalEvent.clipboardData.items[0];if(item.kind!=='file'||item.type.substring(0,5)!=='image')return;var blob=item.getAsFile();var reader=new FileReader();reader.onload=function(e){img.onload=function(){self.resize()};img.src=e.target.result};reader.readAsDataURL(blob)})};self.resize=function(){var dpr=W.devicePixelRatio;if(dpr>1){canvas.width=img.width/dpr;canvas.height=img.height/dpr}else{canvas.width=img.width;canvas.height=img.height}if(canvas.width>config.maxwidth){canvas.width=config.maxwidth;canvas.height=(img.height*(config.maxwidth/img.width)>>0)}else if(canvas.height>config.maxheight){canvas.height=config.maxheight;canvas.width=(img.width*(config.maxheight/img.height))>>0}ctx.drawImage(img,0,0,canvas.width,canvas.height);var data=config.type==='png'?canvas.toDataURL('image/png'):canvas.toDataURL('image/jpeg',config.quality*0.01);if(config.output==='file')data=dataURLtoFile(data,'screenshot.'+config.type);config.exec&&self.EXEC(config.exec,data);EMIT('clipboardimage',data)}});
...
COMPONENT('faviconunread','bg:red;fg:white;badge:true',function(self,config){var tmp={};self.singleton();self.readonly();self.make=function(){var head=$(config.selector||document.head);tmp.el=config.selector?head:head.find('link[rel="icon"]');if(!tmp.el.length){head.append('<link rel="icon" href="data:image/gif;base64,R0lGODdhIAAgAIAAAP///wAAACwAAAAAIAAgAAACHoSPqcvtD6OctNqLs968+w+G4kiW5omm6sq27gubBQA7" type="image/gif" />');tmp.el=head.find('link[rel="icon"]')}tmp.href=tmp.el.attr('href')||tmp.el.attr('src');tmp.type=tmp.el.attr('type')};self.setter=function(value){if(!value){tmp.el.attr({type:tmp.type,href:tmp.href});return}var canvas=document.createElement('canvas');var img=new Image();img.src=tmp.href;img.onload=function(){canvas.width=img.width;canvas.height=img.height;var ctx=canvas.getContext('2d');ctx.drawImage(img,0,0);ctx.fillStyle=config.bg;var size=img.width/3.4;ctx.arc(img.width-size,img.height-size,size,0,2*Math.PI);ctx.fill();ctx.textAlign='center';ctx.fillStyle=config.fg;ctx.font='bold 12px Arial';if(value>99)value='99';else value+='';ctx.fillText(value,img.width-size,img.height-5);if(config.selector)tmp.el.attr('src',canvas.toDataURL());else tmp.el.attr({type:'image/png',href:canvas.toDataURL()});canvas=img=null;if(config.badge){try{navigator.setAppBadge&&navigator.setAppBadge(value?(+value):0)}catch{}}}}});
...
COMPONENT('idletime','count:300',function(self,config){var is=false,count=0,countfocus=0,interval,interval_rebind,ticks,rebinded=false,$W=$(W);self.singleton();self.readonly();function rebind(){if(is){EMIT('idletime',false);self.path&&self.set(false)}is=false;countfocus=0;count=0;unbind();interval_rebind&&clearTimeout(interval_rebind);interval_rebind=setTimeout(rebind2,config.count*100)}function rebind2(){if(!rebinded){$W.on('mousemove mousewheel click keyup touchstart focus scroll pageshow',rebind);rebinded=true}}function unbind(){if(rebinded){$W.off('mousemove mousewheel click keyup touchstart focus scroll pageshow',rebind);rebinded=false}}self.destroy=function(){interval_rebind&&clearTimeout(interval_rebind);clearInterval(interval);interval=null;unbind()};self.make=function(){$(document).on('visibilitychange',function(){var now=Date.now();if(document.hidden){ticks=now}else{var diff=Math.ceil((now-ticks)/1000);if(diff>=config.count){rebind();setTimeout(()=>EMIT('reload'),500)}ticks=now}});rebind2();interval=setInterval(function(){if(document.hasFocus())countfocus=0;else countfocus++;if((count>config.count||countfocus>config.count)&&!is){is=true;self.path&&self.set(is);EMIT('idletime',is)}else count++},1000)}});
...
COMPONENT('nativenotifications','timeout:8000',function(self,config){var autoclosing,system=false,N=W.Notification;self.singleton();self.readonly();self.nocompile&&self.nocompile();self.items=[];self.make=function(){if(!N)return;system=N.permission==='granted';!system&&N.requestPermission(function(permission){system=permission==='granted'})};self.show=self.append=function(title,message,callback,img){if(!system)return;var obj={id:Math.floor(Math.random()*100000),date:new Date(),callback:callback};var options={};options.body=message.replace(/(<([^>]+)>)/ig,'');self.items.push(obj);self.autoclose();if(img===undefined)options.icon=config.icon||'/icon.png';else if(img!=null)options.icon=img;obj.system=new N(title,options);obj.system.onclick=function(){W.focus();self.items=self.items.remove('id',obj.id);if(obj.callback){obj.callback();obj.callback=null}obj.system.close();obj.system.onclick=null;obj.system=null}};self.autoclose=function(){if(autoclosing)return self;autoclosing=setTimeout(function(){clearTimeout(autoclosing);autoclosing=null;var obj=self.items.shift();if(obj){obj.system.onclick=null;obj.system.close();obj.system=null}self.items.length&&self.autoclose()},config.timeout)}});
...
COMPONENT('objecteditor','null:true;dateformat:yyyy-MM-dd HH\\:mm\\:ss',function(self,config){self.nocompile&&self.nocompile();var skip=false,tstringmultiline='<div class="ui-oe-string-multiline ui-oe-item"><div class="ui-oe-label"><span>{label}</span></div><div class="ui-oe-control"><textarea data-type="string" name="{path}">{value}</textarea></div></div>',tstring='<div class="ui-oe-string ui-oe-item"><div class="ui-oe-label"><span>{label}</span></div><div class="ui-oe-control"><input type="text" data-type="string" name="{path}" value="{value}" /></div></div>',tdate='<div class="ui-oe-date ui-oe-item"><div class="ui-oe-label"><span>{label}</span></div><div class="ui-oe-control"><input type="text" data-type="date" name="{path}" value="{value}" /></div></div>',tnumber='<div class="ui-oe-number ui-oe-item"><div class="ui-oe-label"><span>{label}</span></div><div class="ui-oe-control"><input type="text" data-type="number" name="{path}" value="{value}" /></div></div>',tboolean='<div class="ui-oe-boolean ui-oe-item"><div class="ui-oe-label"><span>{label}</span></div><div class="ui-oe-control"><div data-name="{path}" class="ui-eo-checkbox{value}"><i class="ti ti-check"></i></div></div></div>',tnull='<div class="ui-oe-null ui-oe-item"><div class="ui-oe-label"><span>{label}</span></div><div class="ui-oe-control">null</div></div>',tgroup='<div class="ui-oe-group ui-oe-level-{level}"><div class="ui-oe-label">{name}</div><div class="ui-oe-items">{body}</div></div>',tarray='<div class="ui-oe-array ui-oe-level-{level}"><div class="ui-oe-label"><b>Array:</b> {name}</div><div class="ui-oe-items">{body}</div></div>';self.configure=function(key,value){if(key==='skip')config.skip=value instanceof Array?value:value.split(',')};self.make=function(){self.aclass('ui-oe');self.event('click','.ui-eo-checkbox',function(){var el=$(this);var cls='checked',name=el.attrd('name');var path=self.path+'.'+name;el.tclass(cls);skip=true;var val=el.hclass(cls);SET(path,val);self.bind('@touched @modified');config.exec&&self.EXEC(config.exec,name,val)});self.event('change','input,textarea',function(){var el=$(this);var type=el.attrd('type');var path=self.path+'.'+this.name,val=this.value;switch(type){case'string':break;case'number':val=val.parseFloat();break;case'date':val=val.parseDate(config.dateformat);break}skip=true;SET(path,val);self.bind('@touched @modified');config.exec&&self.EXEC(config.exec,this.name,val)})};self.redraw=function(path,obj,level){var arr=Object.keys(obj);var builder=[];for(var i=0;i<arr.length;i++){var key=arr[i],val=obj[key];if(val==null)continue;var tmp={};tmp.pathraw=(path?(path+'.'):'')+key;if(!config.null||(config.skip&&config.skip.indexOf(tmp.pathraw)!==-1))continue;tmp.path=tmp.pathraw;tmp.label=key;tmp.value=val;if(val==null){builder.push(tnull.args(tmp));continue}var type=typeof(val);if(type==='string'){tmp.value=Tangular.helpers.encode(tmp.value);if(tmp.value.indexOf('\n')==-1)builder.push(tstring.args(tmp));else builder.push(tstringmultiline.args(tmp))}else if(type==='number')builder.push(tnumber.args(tmp));else if(type==='boolean'){tmp.value=val?' checked':'';builder.push(tboolean.args(tmp))}else{if(val instanceof Date){tmp.value=tmp.value.format(config.dateformat);builder.push(tdate.args(tmp))}else if(val instanceof Array){type=typeof(val[0]);var sub=[];if(type==='number'){for(var j=0;j<val.length;j++){tmp.path=tmp.pathraw+'['+j+']';tmp.value=val[j];sub.push(tnumber.args(tmp))}}else if(type==='string'){for(var j=0;j<val.length;j++){tmp.path=tmp.pathraw+'['+j+']';tmp.value=val[j];tmp.value=Tangular.helpers.encode(tmp.value);sub.push(tstring.args(tmp))}}else if(type==='boolean'){for(var j=0;j<val.length;j++){tmp.path=tmp.pathraw+'['+j+']';tmp.value=val[j];sub.push(tboolean.args(tmp))}}else{for(var j=0;j<val.length;j++)sub.push(self.redraw(tmp.pathraw+'['+j+']',val[j],j+1))}sub.length&&builder.push(tarray.args({name:tmp.pathraw,body:sub.join(''),level:level}))}else builder.push(self.redraw(tmp.path,val,level+1))}}var output=builder.join('');return level?tgroup.args({name:path,body:output,level:level}):output};self.setter=function(value){if(value==null)return;if(skip){skip=false;return}self.html(self.redraw('',value,0))}});
...
COMPONENT('paper','readonly:0;margin:0;widgets:https://cdn.componentator.com/paper/db.json;autosave:1;placeholder:Press / for adding rich content',function(self,config,cls){self.initd={};self.meta={};self.cmd={};self.format={};self.inlinecss=[];var D=document,openeditor,selected,nosync=false,oldcss,pendingwidgets=false,settings={},checksum={},skip=false,check=null,previndex=null,prevcleaner=null,prevclean=function(){previndex=null};var movement=function(key){var sel=W.getSelection();var parent=sel.anchorNode.parentNode;if(parent===openeditor.parentNode){var owner=parent.parentNode,count=owner.children.length,index=-1;if(sel.anchorNode.getAttribute&&sel.anchorNode.getAttribute('contenteditable')){openeditor.key=key;openeditor.close()}else index=NODEINDEXOF(parent);if((key===38&&index===0)||(key===40&&(index===count-1))){if(previndex!==index){previndex=index;prevcleaner&&clearTimeout(prevcleaner);prevcleaner=setTimeout(prevclean,1000);return}openeditor.key=key;openeditor.close()}}else openeditor.parentNode=parent};var htmlwidget=function(widget){widget.show();widget.save=function(){return{html:widget.element.html()}};var edit=function(e){if(config.readonly||!widget.iseditable2())return;if(e){var clslist=e.target.classList;if(clslist.contains('picon')||clslist.contains('plink'))return;e.preventDefault();e.stopPropagation()}self.cmd.edit(widget.element,{widget:widget,commands:true,multiline:true,placeholder:widget.newbie},function(response){if(response.text){widget.change('update');widget.end(response.key)}else widget.remove()})};widget.element.on('click',edit);widget.on('focus',edit);if(widget.config.html)widget.element.html(widget.config.html);if(widget.newbie){config.placeholder&&widget.element.parent().prepend('<div class="{0}-placeholder">{1}</div>'.format(cls,config.placeholder));self.cmd.select(widget);setTimeout(edit,10)}};self.makeid=function(){return Date.now().toString(36)+'X'+Math.random().toString(36).substring(3,7)};self.removeselection=function(){var arr=document.getSelection().getRangeAt(0).cloneContents().querySelectorAll('*');for(var el of arr){var element=el.classList.contains('widget')?$(el):$(el).closest('.widget');if(element.length){var id=element.attrd('id');self.find('.widget[data-id="{0}"]'.format(id)).remove()}}};self.format.link=function(){var sel=self.getSelection().trim();if(!sel)return;var el=openeditor.element,url='#link'+Date.now().toString(36);var mtd=el[0];for(var i=0;i<5;i++){if(mtd.tagName==='A')return;mtd=mtd.parentNode;if(!mtd)break}document.execCommand('CreateLink',false,url);var tmp=el.find('a[href="'+url+'"]');if(!tmp.length)return;var content=tmp.text();var link={};link.element=tmp;link.href='';tmp.aclass('plink');openeditor&&openeditor.close();if(content.indexOf('@')!==-1)link.href='mailto:'+content;else if((/^[0-9\s+-]+$/).test(content))link.href='tel:'+content;else if(content.indexOf(' ')===-1&&content.indexOf(',')===-1&&content.indexOf('.')!==-1)link.href=(/http(s):\/\//).test(content)?content:('https://'+content);link.target=link.href.indexOf('.')!==-1&&link.href.indexOf(location.hostname)===-1?'_blank':'';link.href&&tmp.attr('href',link.href);link.target&&tmp.attr('target',link.target);link.widget=self;config.link&&setTimeout(()=>self.EXEC(config.link,link),200)};self.format.bold=function(){document.execCommand('Bold',false,null)};self.format.code=function(){var url='#code'+Date.now().toString(36);document.execCommand('CreateLink',false,url);var a=openeditor.element.find('a[href="{0}"]'.format(url));a.replaceWith('<span class="pcode">'+a.html()+'</span>')};self.format.italic=function(){document.execCommand('Italic',false,null)};self.format.underline=function(){document.execCommand('Underline',false,null)};self.format.icon=function(){var tag=openeditor.element[0].nodeName.toLowerCase();var icon='<i class="ti ti-flag picon" contenteditable="false"></i>';switch(tag){case'span':$(openeditor.element).parent().prepend(icon);break;default:document.execCommand('insertHTML',false,icon);break}};self.cmd.edit=function(el,opt,callback){if(config.readonly)return;if(!(el instanceof jQuery))el=$(el);if(!opt)opt={};if(opt.format==null)opt.format=true;if(callback)opt.callback=callback;if(openeditor){if(openeditor.element[0]==el[0])return;openeditor.close();setTimeout(self.cmd.edit,100,el,opt,callback);return}var widgetel=el.closest('.widget')[0];if(!widgetel)return;opt.backup=el.html();opt.html&&el.html(opt.html);el.attr('contenteditable',true);openeditor={};openeditor.widget=widgetel.$widget;openeditor.element=el;openeditor.dom=el[0];openeditor.multiline=opt.multiline;openeditor.parent=opt.parent?opt.parent[0]:openeditor.dom;var clickoutside=function(e){if(!(e.target===openeditor.parent||openeditor.parent.contains(e.target)))openeditor.close()};var clickme=function(){openeditor.timeout&&clearTimeout(openeditor.timeout);openeditor.timeout=setTimeout(loadformat,150)};var paste=function(e){e.preventDefault();var text=(e.originalEvent||e).clipboardData.getData('text/plain');document.execCommand('insertHTML',false,text)};var keydown=function(e){opt.keydown&&opt.keydown(e);openeditor.timeout&&clearTimeout(openeditor.timeout);openeditor.timeout=setTimeout(loadformat,150);if(e.keyCode===27){e.preventDefault();e.stopPropagation();openeditor.key=27;openeditor.close();return}if(opt.backslashremove&&e.keyCode===8&&!el.text().trim()){openeditor.key=8;openeditor.close();return}if(e.keyCode===13){if(!opt.multiline||e.shiftKey||e.metaKey){e.preventDefault();e.stopPropagation();openeditor.key=13;openeditor.close()}return}if(e.keyCode===9){e.preventDefault();if(opt.tabs){document.execCommand('insertHTML',false,'&#009');return}if(opt.endwithtab){openeditor.key=9;openeditor.close();return}e.stopPropagation();var widget=openeditor.widget;openeditor.key=9;openeditor.close();var w=widget.element.parent().next().find('> .widget')[0];if(w){w=w.$widget;self.cmd.select(w);setTimeout(w=>w.emit('focus'),100,w)}return}if(opt.commands&&e.keyCode===191){var cmd={};cmd.element=$(this);if(!el.text().trim()){var cache=W.papercache||EMPTYOBJECT;cmd.widget=opt.widget;cmd.widgets=cache.widgets;cmd.remove=function(){opt.widget.remove()};cmd.append=function(name){var w=W.papercache.instances[name],id=self.makeid();settings[id]=w.config;opt.widget.element.parent().after('<section><div class="widget paper-{0}" data-widget="{0}" data-id="{1}" data-newbie="1"></div></section>'.format(name,id));opt.widget.remove();self.cmd.refresh()};config.command&&self.EXEC(config.command,cmd);e.preventDefault()}return}openeditor.change=true;if(!e.metaKey&&!e.ctrlKey)return;if(e.keyCode===66){if(opt.format&&(opt.bold==null||opt.bold==true))self.format.bold();e.preventDefault();e.stopPropagation();return}if(e.keyCode===77){if(opt.format&&(opt.code==null||opt.code==true))self.format.code();e.preventDefault();e.stopPropagation();return}if(e.keyCode===76){if(opt.format&&(opt.link==null||opt.link==true))self.format.link();e.preventDefault();e.stopPropagation();return}if(e.keyCode===73){if(opt.format&&(opt.italic==null||opt.italic==true))self.format.italic();e.preventDefault();e.stopPropagation();return}if(e.keyCode===80){self.format.icon();e.preventDefault();e.stopPropagation();return}if(e.keyCode===85){if(opt.format&&(opt.underline==null||opt.underline==true))self.format.underline();e.preventDefault();e.stopPropagation();return}if(e.keyCode===32){document.execCommand('insertHTML',false,'&nbsp;');e.preventDefault();e.stopPropagation();return}};var keyup=function(e){if(!openeditor.multiline&&(e.keyCode===40||e.keyCode===38))movement(e.keyCode)};el.focus();if(opt.cursor==='end'){var range=document.createRange();range.selectNodeContents(el[0]);range.collapse(false);var sel=W.getSelection();sel.removeAllRanges();sel.addRange(range)}if(opt.select)setTimeout(()=>document.execCommand('selectAll',false,null),20);openeditor.close=function(){$(W).off('click',clickoutside);el.off('click',clickme);el.rattr('contenteditable');el.off('keydown',keydown);el.off('paste',paste);el.off('keyup',keyup);el.off('input');openeditor.timeout&&clearTimeout(openeditor.timeout);if(opt.callback){var arg={};arg.text=el.text();arg.html=el.html();arg.change=openeditor.change;arg.element=openeditor.element;arg.dom=openeditor.dom;arg.backup=opt.backup;arg.key=openeditor.key;arg.param=opt.param;opt.callback(arg)}openeditor=null;config.format&&self.EXEC(config.format,null)};$(W).on('click',clickoutside);el.on('keydown',keydown);el.on('click',clickme);if(opt.placeholder){var placeholder=el.closest('section').find('.'+cls+'-placeholder')[0];var placeholderprev=false;placeholder&&el.on('input',function(){var is=this.innerHTML.length>0;if(placeholderprev!==is){placeholderprev=is;placeholder.classList.toggle('hidden',is)}})}el.on('paste',paste);el.on('keyup',keyup)};self.cmd.rebuildcss=function(){var builder=[];for(var item of self.inlinecss)builder.push(item.css);var tmp=builder.join('');if(tmp!==oldcss){oldcss=tmp;CSS(tmp,self.ID)}};self.cmd.change=function(widget,type,el){if(nosync)return;if(el&&!(el instanceof jQuery))el=$(el);var data={},parent=widget.element.parent();data.id=widget.element.attrd('id');var clone=parent.clone();clone.find('.selected').rclass('selected');clone.find('[contenteditable]').rattr('contenteditable');data.html=clone.html();data.type=type;data.widget=widget.name;data.indexes=[];var arr=self.find('.widget');for(var item of arr)data.indexes.push(item.getAttribute('data-id'));var prev=parent.prev();if(prev)data.prev=prev.find('> .widget').attrd('id');if(el){prev=el?el.prev():null;data.block=el.attrd('id');if(prev.length)data.blockprev=prev.attrd('id')}widget.changed=true;config.change&&self.EXEC(config.change,data);if(config.autosave){self.save(function(response,is){if(is){skip=true;self.bind('@modified @touched',response)}else self.bind('@touched')})}};self.cmd.cleaner=function(){var arr=self.find('.widget');for(var el of arr){var w=el.$widget;if(w&&(!w.dom.parentNode||!w.dom.innerHTML.trim())){if(!openeditor||openeditor.widget!==w)w.remove()}}};self.cmd.refresh=function(disablesync){var elements=self.find('.widget');if(disablesync)nosync=true;for(var el of elements){if(el.$widget)continue;el.$widget=self.cmd.parse(el);var is=false,w=el.$widget;if(!self.initd[w.name]){self.initd[w.name]=1;is=true}if(w.newbie)w.sync=false;if(w.name==='html'){htmlwidget(w)}else{if(config.widget){self.EXEC(config.widget,w,is,W.papercache)}else{var widget=W.papercache.instances[w.name];if(widget){widget.html&&w.element.append(widget.html);try{widget.make(w,w.config,w.element)}catch(e){console.error(w.name,w.id,e)}}}}}if(disablesync)nosync=false};self.cmd.widgets=function(){var elements=self.find('.widget');var arr=[];for(var el of elements)el.$widget&&arr.push(el.$widget);return arr};self.cmd.parse=function(el){var id=el.getAttribute('data-id');var name=el.getAttribute('data-widget');var meta={id:id,name:name,config:settings[id]||{},element:$(el),paper:self,readonly:config.readonly,events:{}};meta.dom=el;meta.newbie=el.getAttribute('data-newbie')==='1';meta.newbie&&el.removeAttribute('data-newbie');meta.widgets={};checksum[id]=HASH(meta.config);meta.widgets.save=function(el){return self.save(null,$(el))};meta.widgets.load=function(el,arr){if(!el||!arr||!(arr instanceof Array)||!arr.length)return;var builder=[];for(var item of arr){settings[item.id]=item.config;builder.push('<section><div class="widget paper-{0}" data-widget="{0}" data-id="{1}"></div></section>'.format(item.widget,item.id))}$(el).html('<section class="{0}-first"></section>'.format(cls)+builder.join(''));self.cmd.refresh()};meta.widgets.append=function(el){if(config.readonly)return;var id=self.makeid();$(el).append('<section><div class="widget paper-html" data-widget="html" data-id="{0}" data-newbie="1"></div></section>'.format(id));self.cmd.refresh()};meta.append=function(same){var id=self.makeid();$(el).parent().after('<section><div class="widget paper-{1}" data-widget="{1}" data-id="{0}" data-newbie="1"></div></section>'.format(id,same===true?name:(same||'html')));setTimeout(self.cmd.refresh,100)};meta.css=function(val){var index=self.inlinecss.findIndex('id',meta.name);if(index===-1){val&&self.inlinecss.push({id:meta.name,css:val})}else{if(val)self.inlinecss[index].css=val;else self.inlinecss.splice(index,1)}setTimeout2(self.ID+'css',self.cmd.rebuildcss,200)};meta.iseditable=function(t){if(t instanceof jQuery)t=t[0];if((t.classList.contains('picon')||t.classList.contains('plink')))return false;if(t.tagName==='A')return false;for(var i=0;i<10;i++){t=t.parentNode;if(t==null)break;if(t.tagName==='A')return false}return true};meta.iseditable2=function(){return check?check(meta):true};meta.edit=function(el,opt,callback){if(meta.iseditable2())self.cmd.edit(el,opt,callback)};meta.focus=function(){if(openeditor)openeditor.close();meta.emit('focus',true)};meta.upload=function(opt,callback){config.upload&&self.EXEC(config.upload,opt,callback)};meta.change=function(type,el){if(!meta.removed){if(!type)type='update';self.cmd.change(meta,type,el)}};meta.show=function(){meta.element.parent().rclass('invisible')};meta.end=function(key){if(key===38){meta.prev()}else if(key===40){meta.next()}else{var parent=meta.element.parent();setTimeout(parent=>parent.trigger('click'),200,parent)}};meta.beg=function(){var parent=meta.element.parent().prev();parent&&parent.length&&setTimeout(parent=>parent.trigger('click'),200,parent)};meta.prev=function(){var parent=meta.element.parent();var prev=parent.prev();if(prev.length){var widget=prev.find('> .widget')[0];if(widget){widget=widget.$widget;self.cmd.select(widget);setTimeout(widget=>widget.emit('focus'),200,widget)}}else setTimeout(parent=>parent.trigger('click'),200,parent)};meta.next=function(){var parent=meta.element.parent();var next=parent.next();if(next.length){var widget=next.find('> .widget')[0].$widget;self.cmd.select(widget);setTimeout(widget=>widget.emit('focus'),200,widget)}else setTimeout(parent=>parent.trigger('click'),200,parent)};meta.remove=function(){meta.removed=true;if(!meta.newbie)self.cmd.change(meta,'remove');meta.element.parent().remove()};meta.makeid=function(){return self.makeid()};meta.update=function(){if(meta.removed)return;if(nosync)nosync=false;meta.change('update')};meta.on=function(name,fn){if(meta.events[name])meta.events[name].push(fn);else meta.events[name]=[fn]};meta.emit=function(name,a,b,c,d){var arr=meta.events[name];if(arr){for(var fn of arr)fn.call(meta,a,b,c,d)}};return meta};self.cmd.select=function(widget){if(selected===widget)return;if(selected){selected.emit('unselect');selected.element.rclass('selected');selected=null}if(widget){widget.emit('select');widget.element.aclass('selected');selected=widget}};self.eat=function(data){if(data.type==='remove'){var tmp=self.find('.widget[data-id="{0}"]'.format(data.id));if(tmp.length){nosync=true;tmp[0].$widget.remove();nosync=false}return}var el=$('<section>{0}</section>'.format(data.html));el.find('.selected').rclass('selected');var wel=self.find('.widget[data-id="{0}"]'.format(data.id));if(wel.length){wel.parent().replaceWith(el);self.cmd.refresh();self.cmd.cleaner();return}if(data.prev){var prev=self.find('.widget[data-id="{0}"]'.format(data.prev));if(prev.length){prev.parent().after(el);self.cmd.refresh();self.cmd.cleaner()}else{}}else{self.append(el);self.cmd.refresh();self.cmd.cleaner()}};self.removeselected=function(){if(!openeditor){var widgets=self.find('.widget.selected');for(var el of widgets)el.$widget.remove()}};self.resize=function(){config.parent&&setTimeout2(self.ID,self.resizeforce,300)};self.resizeforce=function(){if(config.parent){var parent=self.parent(config.parent);self.css('min-height',parent.height()-config.margin)}};self.import=function(arr,callback){if(typeof(arr)==='string')arr=[arr];var cache=W.papercache,imports=[];if(!cache)W.papercache=cache={imported:{},instances:{},widgets:{},init:false};arr.wait(function(url,next){if(cache.imported[url]){next();return}AJAX('GET '+url,function(response){cache.imported[url]=true;if(typeof(response)==='object'){for(var item of response){new Function('exports',item.js)(item);if(cache.instances[item.id])WARN('Overwriting paper widget:',item.id);cache.instances[item.id]=item;item.js=undefined;if(item.css)item.css=item.css.replace(/CLASS/g,'paper-'+item.id);if(item.import){for(var m of item.import)imports.push(m)}}next();return}var index=response.indexOf('<st'+'yle>');var css=index===-1?'':response.substring(index+7,response.indexOf('</sty'+'le>',index+7)).trim();index=response.indexOf('<bo'+'dy>');var html=index===-1?'':response.substring(index+6,response.indexOf('</bo'+'dy>',index+6)).trim();index=response.indexOf('<scr'+'ipt>');var js=response.substring(index+8,response.indexOf('</scr'+'ipt>',index+8)).trim();var widget={};widget.css=css;widget.js=js;widget.html=html;new Function('exports',js)(widget);if(widget.css)widget.css=widget.css.replace(/CLASS/g,'paper-'+widget.id);if(cache.instances[widget.id])WARN('Overwriting paper widget:',widget.id);cache.instances[widget.id]=widget;if(widget.import){for(var m of widget.import)imports.push(m)}next()})},function(){imports.wait(function(item,next){IMPORT(item,next)},function(){cache.init=true;self.reimport();callback&&callback();if(pendingwidgets){pendingwidgets=false;self.refresh()}},3)})};self.reimport=function(){var cache=W.papercache;if(cache){var css=[],widgets=[];for(var key in cache.instances){var w=cache.instances[key];w.css&&css.push(w.css);widgets.push(w)}cache.widgets=widgets;CSS(css.join('\n'),'paper');UPD('papercache')}};self.save=function(callback,el){var body=$(el||self.element);var items=[],arr=body.find('> section > .widget');var ischange=false;for(var child of arr){var child=$(child);var name=child.attrd('widget');if(!name)continue;var id=ATTRD(child);var w=child[0].$widget;if(!w)continue;var cfg;if(w.removed){ischange=true;continue}try{cfg=w.save?w.save():{}}catch(e){console.error(e);cfg={}}if(!ischange){var sum=HASH(cfg);if(checksum[id]!==sum)ischange=true}items.push({id:id,widget:name,changed:w.changed,newbie:w.newbie,config:cfg})}callback&&callback(items,ischange);return items};self.make=function(){self.aclass(cls);self.rclass('hidden invisible');self.append('<section class="{0}-first"></section>'.format(cls));config.contextmenu&&self.event('contextmenu','.widget',function(e){self.EXEC(config.contextmenu,this.$widget,e)});self.event('click','section',function(e){var t=this;if(config.readonly)return;if(e.target.tagName==='A'||$(e.target).closest('a,[data-prevent]').length)return;var target=e.target;e.stopPropagation();if(target.classList.contains('plink'))return;e.preventDefault();if(target.classList.contains('picon')){if(openeditor)openeditor.close();var opt={};opt.element=$(e.target);opt.widget=opt.element.closest('.widget')[0].$widget;config.icon&&self.EXEC(config.icon,opt,function(){opt.widget.change('update')});return}if(openeditor)openeditor.close();setTimeout(function(){$(t).after('<section><div class="widget whtml" data-widget="html" data-id="{0}" data-newbie="1"></div></section>'.format(self.makeid()));self.cmd.refresh()},100)});self.event('click','.widget',function(){if(!config.readonly)self.cmd.select(this.$widget)});self.event('click',function(e){if(config.readonly)return;if(e.target===self.dom){if(openeditor){openeditor.close();return}self.append('<section><div class="widget whtml" data-widget="html" data-id="{0}" data-newbie="1"></div></section>'.format(self.makeid()));self.cmd.refresh()}})};var loadformat=function(){if(!openeditor)return;openeditor.timeout=null;var node=self.getNode();var toolbar={},style={};toolbar.node=node;toolbar.element=openeditor.element;toolbar.widget=openeditor.widget;toolbar.style=style;while(node){if(node===self.dom||node===openeditor.dom)break;switch(node.tagName){case'B':style.bold=1;break;case'I':style.italic=1;break;case'A':style.link=1;break;case'SPAN':style.mark=1;break;case'CODE':style.code=1;break;case'S':style.strike=1;break;case'U':style.underline=1;break}node=node.parentNode}config.format&&self.EXEC(config.format,toolbar,self)};self.getNode=function(){var node=D.getSelection().anchorNode;if(node)return(node.nodeType===3?node.parentNode:node)};self.getSelection=function(node){if(D.selection&&D.selection.type==='Text')return D.selection.createRange().htmlText;else if(!W.getSelection)return;var sel=W.getSelection();if(!sel.rangeCount)return'';var container=D.createElement('div');for(var i=0,len=sel.rangeCount;i<len;++i)container.appendChild(sel.getRangeAt(i).cloneContents());return node?container:container.innerHTML};self.configure=function(key,value){switch(key){case'check':check=value?GET(self.makepath(value)):null;break;case'readonly':value&&openeditor&&openeditor.close();self.tclass(cls+'-r readonly',!!value);self.tclass(cls+'-w',!value);var tmp=self.find('.widget');for(var w of tmp)w.$widget.readonly=value;break;case'widgets':value&&self.import(value.split(',').trim());break}};self.notify=function(a,b,c,d,e){var widgets=self.find('.widget');for(var el of widgets)el.$widget.emit(a,b,c,d,e)};self.setter=function(arr){if(skip){skip=false;return}if(!config.widget){if(!W.papercache||!W.papercache.init){pendingwidgets=true;return}}selected=null;var tempsettings={},sections=self.find('> section').toArray();var prev=sections.shift();var el;for(var m of sections){el=$(m).find('> div');m.PID=ATTRD(el);m.PIS=false}if(!arr)arr=EMPTYARRAY;var template='<section><div class="widget paper-{0}" data-widget="{0}" data-id="{1}"></div></section>';for(var i=0;i<arr.length;i++){var item=arr[i],sum=checksum[item.id],ischange=false;if(item.config){tempsettings[item.id]=item.config;checksum[item.id]=HASH(item.config);ischange=sum!==checksum[item.id]}else tempsettings[item.id]=settings[item.id];var index=sections.findIndex('PID',item.id);if(index===-1){el=$(template.format(item.widget,item.id))[0];NODEINSERT(el,prev);prev=el}else if(index!==i){if(ischange){el=$(template.format(item.widget,item.id))[0];NODEINSERT(el,prev)}else{el=sections[index];el.PIS=true;NODEINSERT(el,prev)}prev=el}else{if(ischange){el=$(template.format(item.widget,item.id))[0];NODEINSERT(el,prev);prev=el}else{el=sections[index];el.PIS=true;prev=el}}}for(var m of sections){if(!m.PIS)m.parentNode.removeChild(m)}var elements=self.find('.widget');for(var el of elements){var widget=el.$widget;if(widget){widget.changed=false;widget.newbie=false}}settings=tempsettings;self.cmd.refresh(true);setTimeout(self.cmd.cleaner,2000)}});
...
COMPONENT('rawinput','type:text',function(self,config,cls){var customvalidator,input;self.autobind20&&self.autobind20();self.validate=function(value){if((!config.required||config.disabled)&&!self.forcedvalidation())return true;if(customvalidator)return customvalidator(value);if(self.type==='date')return value instanceof Date&&!isNaN(value.getTime());if(value==null)value='';else value=value.toString();if(config.minlength&&value.length<config.minlength)return false;switch(self.type){case'email':return value.isEmail();case'phone':return value.isPhone();case'url':return value.isURL();case'zip':return(/^\d{5}(?:[-\s]\d{4})?$/).test(value);case'currency':case'number':value=value.parseFloat();if((config.minvalue!=null&&value<config.minvalue)||(config.maxvalue!=null&&value>config.maxvalue))return false;return config.minvalue==null?value>0:true}return value.length>0};self.formatter(function(path,value){if(value){switch(config.type){case'lower':return(value+'').toLowerCase();case'upper':return(value+'').toUpperCase();case'phone':return(value+'').replace(/\s/g,'');case'email':return(value+'').toLowerCase();case'date':return value.format(config.format||'yyyy-MM-dd');case'time':return value.format(config.format||'HH:mm');case'number':return config.format?value.format(config.format):value}}return value});self.parser(function(path,value){if(value){var tmp;switch(config.type){case'date':tmp=self.get();if(tmp)tmp=tmp.format('HH:mm');else tmp='';return value+(tmp?(' '+tmp):'');case'lower':case'email':value=value.toLowerCase();break;case'upper':value=value.toUpperCase();break;case'phone':value=value.replace(/\s/g,'');break;case'time':tmp=value.split(':');var dt=self.get();if(dt==null)dt=new Date();dt.setHours(+(tmp[0]||'0'));dt.setMinutes(+(tmp[1]||'0'));dt.setSeconds(+(tmp[2]||'0'));value=dt;break}}return value?config.spaces===false?value.replace(/\s/g,''):value:value});self.make=function(){self.aclass(cls);var attr=[];config.type&&attr.attr('type',config.type==='password'?'password':'text');config.maxlength&&attr.attr('maxlength',config.maxlength);config.placeholder&&attr.attr('placeholder',config.placeholder);config.autofocus&&attr.push('autofocus');if(config.autofill){attr.attr('autocomplete','on');attr.attr('name',self.path)}else{attr.attr('name',Date.now()+'');attr.attr('autocomplete','new-password')}self.append('<input data-jc-bind="" {0} />'.format(attr.join(' ')));var $input=self.find('input');input=$input[0];config.enter&&$input.on('keydown',function(e){if(e.which===13)self.SEEX(config.enter,input.value,self)});$input.on('focus',function(){var el=$(this);if(config.disabled){el.blur();return}self.aclass(cls+'-focused');config.autocomplete&&self.EXEC(config.autocomplete,self,el.parent());if(config.autosource){var opt={};opt.element=self.element;opt.search=GET(self.makepath(config.autosource));opt.callback=function(value){var val=typeof(value)==='string'?value:value[config.autovalue];if(config.autoexec){self.EXEC(config.autoexec,value,function(val){self.set(val,2);self.change();self.bindvalue()})}else{self.set(val,2);self.change();self.bindvalue()}};SETTER('autocomplete/show',opt)}}).on('blur',function(){self.rclass(cls+'-focused')})};self.configure=function(key,value){switch(key){case'disabled':self.tclass('ui-disabled',!!value);input.prop('readonly',!!value);self.reset();break;case'readonly':input.prop('readonly',!!value);self.reset();break;case'required':self.tclass(cls+'-required',!!value);self.reset();break;case'type':self.type=value;break;case'validate':customvalidator=value?(/\(|=|>|<|\+|-|\)/).test(value)?FN('value=>'+value):(function(path){path=self.makepath(path);return function(value){return GET(path)(value)}})(value):null;break;case'monospace':self.tclass(cls+'-monospace',!!value);break}};self.preparevalue=function(value){if(self.type==='number'&&(config.minvalue!=null||config.maxvalue!=null)){var tmp=typeof(value)==='string'?+value.replace(',','.'):value;if(isNaN(tmp))tmp=0;if(config.minvalue>tmp)value=config.minvalue;if(config.maxvalue<tmp)value=config.maxvalue}return value};self.getterin=self.getter;self.getter=function(value,realtime,nobind){self.getterin(self.preparevalue(value),realtime,nobind)};self.setter=function(value){input.value=self.formatter(value==null?'':value)};self.state=function(type){if(type){var invalid=config.required?self.isInvalid():self.forcedvalidation()?self.isInvalid():false;if(invalid===self.$oldstate)return;self.$oldstate=invalid;self.tclass(cls+'-invalid',invalid)}};self.forcedvalidation=function(){if(!config.forcevalidation)return false;if(self.type==='number')return false;var val=self.get();return(self.type==='phone'||self.type==='email')&&(val!=null&&(typeof(val)==='string'&&val.length!==0))}});
